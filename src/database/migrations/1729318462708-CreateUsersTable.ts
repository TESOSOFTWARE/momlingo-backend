...
export class CreateUsersTable1729318462708 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`users\` ADD CONSTRAINT \`FK_b19cfff51c326508beea260b739\` FOREIGN KEY (\`partnerId\`) REFERENCES \`users\`(\`id\`) ON DELETE SET NULL ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`users\` DROP FOREIGN KEY \`FK_b19cfff51c326508beea260b739\``);
        await queryRunner.query(`DROP INDEX \`REL_b19cfff51c326508beea260b73\` ON \`users\``);
